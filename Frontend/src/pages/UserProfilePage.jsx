            ...
            <div className="bg-[#1d2734] mb-[300px] flex min-h-screen">
                ...
                <div className=" flex w-full justify-between">
                    {profile && profile.coverphoto ? (
                        <div className={`bg-no-repeat bg-center bg-cover bg-fixed  items-center absolute h-[340px] w-[1200px]`} style={{ backgroundImage: `linear-gradient(90deg, rgba(29,39,52,0.3) 0%, rgba(29,39,52,0.6) 40%, rgba(29,39,52,0.9) 67%, rgba(29,39,52,1) 100%), url(${profile.coverphoto})`, }}></div>
                    ) : (
                        <div
                            className={`bg-no-repeat bg-cover bg-center bg-fixed items-center absolute h-[340px]`}
                            style={{ backgroundImage: `linear-gradient(90deg, rgba(29,39,52,0.3) 0%, rgba(29,39,52,0.6) 40%, rgba(29,39,52,0.9) 67%, rgba(29,39,52,1) 100%)`, }}
                        ></div>
                    )}
                    <div className="w-full z-[1] pt-[90px] pl-20 p-5 pr-20">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm tracking-wide flex justify-start gap-1 items-center text-white font-light mb-2 ">
                                        ...
                                        <div className="px-2 w-full h-full py-1 border-[1px] border-transparent">
                                            <div>{profile && <div>{profile.location}</div>}</div>
                                        </div>
                                    </div>
                        ...
                        <div
                            className={`mt-10 flex justify-center items-center border-gray-600 border-b-[1px] ${styles.graphbackground}`}
                        ></div>
                        <div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-row items-center justify-start gap-4 mt-4">
                            ...
                            <div className="flex flex-col justify-center items-start">
                                ...
                                <div className="hover:underline">
                                    <Link to={`profile/${profile?.username}`}>@<span className="font-['Montserrat'] italic">
                                        {profile?.username}
                                    </span>
                                    </Link>
                                </div>
                        ...
                        <div className="flex items-center justify-between pt-3">
                            ...
                            {/* <div className="flex items-center justify-center gap-2">
                                <img className="w-5 h-5" src={heart} alt="Like Button" />
                                <img className="w-5 h-5" src={bookmark} alt="Like Button" />
                            </div> */}
                        </div>
                    </div>
                </div>
