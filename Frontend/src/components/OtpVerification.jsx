...
import { sendEmailOtpapi, verifyEmailOtpapi } from "../services/api";
import Otp from "./Otp";
            ...
            <div className="flex flex-col">
                ...
                <div className="text-right text-[#ffffffae] mt-4">
                    {timer > 0 ? (
                        ...
                        <button className="text-sm font-['Exo'] cursor-pointer" onClick={handleResendOtp} disabled={isResendDisabled} >
                            Resend OTP
                        </button>
                    )}
                </div>
